...
require (
	...
	k8s.io/api/networking/v1alpha1 v0.0.0-00010101000000-000000000000
)
...
replace (
	...
	k8s.io/api => /home/plw/git/multi-network/kubernetes/staging/src/k8s.io/api
	k8s.io/api/networking/v1alpha1 => /home/plw/git/multi-network/kubernetes/staging/src/k8s.io/api/networking/v1alpha1
	k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver v0.22.8
	k8s.io/apimachinery => /home/plw/git/multi-network/kubernetes/staging/src/k8s.io/apimachinery
	k8s.io/apiserver => k8s.io/apiserver v0.22.8
	k8s.io/cli-runtime => k8s.io/cli-runtime v0.22.8
	k8s.io/client-go => /home/plw/git/multi-network/kubernetes/staging/src/k8s.io/client-go
...
replace k8s.io => /home/plw/git/multi-network/kubernetes/staging/src/k8s.io
